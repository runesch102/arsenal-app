...
const ARSENAL_WHITELIST = [
  ...
  'nuclei','httpx','subfinder','waybackurls','feroxbuster','rustscan',
  'john','socat','mtr','tshark','arping','dirsearch','wfuzz',
  'lynis','impacket-secretsdump','impacket-psexec','impacket-wmiexec',
  'impacket-smbexec','impacket-ntlmrelayx','impacket-GetNPUsers',
  'impacket-GetUserSPNs','hashcat','crackmapexec','netexec','nxc',
  'nikto.pl','perl',
];
